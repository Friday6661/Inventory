...
namespace Inventory.API.Data.Migrations
{
    ...
    [Migration("20231129125824_CreateTransactionItem")]
    partial class CreateTransactionItem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Inventory.API.Data.Item", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2023, 11, 29, 19, 58, 24, 565, DateTimeKind.Local).AddTicks(8999),
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2023, 11, 29, 19, 58, 24, 565, DateTimeKind.Local).AddTicks(9004),
            ...
            modelBuilder.Entity("Inventory.API.Data.ItemCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2023, 11, 29, 19, 58, 24, 565, DateTimeKind.Local).AddTicks(8675),
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2023, 11, 29, 19, 58, 24, 565, DateTimeKind.Local).AddTicks(8703),
            ...
            modelBuilder.Entity("Inventory.API.Data.Supplier", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 11, 29, 19, 58, 24, 565, DateTimeKind.Local).AddTicks(9608),
            ...
            modelBuilder.Entity("Inventory.API.Data.Warehouse", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Address = "Danger Line 001",
                            CreatedAt = new DateTime(2023, 11, 29, 19, 58, 24, 565, DateTimeKind.Local).AddTicks(9309),
                            IsDeleted = false,
                            Name = "Warehouse-01",
                            TotalCapacity = 5000,
                            UsedCapacity = 45
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "fb2e49d3-205f-4bd4-a2dc-394a46eaf083",
                            Name = "Administrator",
                            NormalizedName = "ADMINISTRATOR"
                        },
                        new
                        {
                            Id = "f3c0c666-1f25-47f5-8c77-f9d5258ca472",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("Inventory.API.Data.Transaction", b =>
                {
                    b.HasOne("Inventory.API.Data.ApiUser", "ApiUser")
                        .WithMany()
